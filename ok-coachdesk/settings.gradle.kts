...
include(":ok-coachdesk-repo-common")
include(":ok-coachdesk-biz")
include(":ok-coachdesk-app-ktor")
include(":ok-coachdesk-app-common")
include(":ok-coachdesk-stub")
include(":ok-coachdesk-repo-stub")
include(":ok-coachdesk-repo-inmemory")
include(":ok-coachdesk-repo-pg")
include(":ok-coachdesk-repo-tests")
